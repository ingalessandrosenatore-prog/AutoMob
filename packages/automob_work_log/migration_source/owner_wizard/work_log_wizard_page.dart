...
import '../widgets/work_type_chip_grid.dart';
...
class WorkLogWizardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => bloc..add(InitKm(vehicleKm: currentKm)),
      child: PopScope(
        canPop: true,
        child: Scaffold(
  ...
  bool _validateData(WorkLogState state) {
    ...
    if (state.type == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Seleziona un tipo di lavoro')),
      );
      return false;
    }
            ...
            builder: (context, state) => Column(
              ...
              children: [
                WorkTypeChipGrid(
                  ...
                  onChanged: (type) => context.read<WorkLogBloc>().add(
