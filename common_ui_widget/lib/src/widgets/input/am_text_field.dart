...
class _AmTextFieldState extends State<AmTextField> {
  ...
  late final ValueNotifier<bool> _obscured = ValueNotifier(widget.obscureText);
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, obscured, _) => Expanded(
        child: Column(
