...
import 'package:auto_mob_v1/features/work_log/presentation/widgets/work_type_chip_grid.dart';
...
void main() {
  ...
  testWidgets('mostra subito il tipo lavoro ricevuto in ingresso', (
    ...
    final chipGrid = tester.widget<WorkTypeChipGrid>(
      find.byType(WorkTypeChipGrid),
    );
    expect(chipGrid.selectedType, EnumPopUp.revisione);
  });
