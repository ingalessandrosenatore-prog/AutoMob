-- La RPC registra il veicolo con i permessi dell'utente autenticato.
-- Il lookup e' immutabile dal client: una SELECT e' sufficiente e mantiene
-- intenzionalmente revocato il permesso UPDATE sulla tabella temporanea.
