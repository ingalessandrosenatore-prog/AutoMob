                  ...
                  Row(
                    children: [
                      AmTextField(
                        ...
                        suffixIcon: const Padding(
                          padding: EdgeInsets.only(top: 14, right: 12),
                          child: Icon(Icons.unfold_more, color: Color(0xFF48484A), size: 20),
                        ),
                      ),
                    ],
                  ),
                    ...
                    child: AmMainFab(
                      ...
                      onPressed: () {
                        context.read<AddVehicleBloc>().add(
                          Step4Submitted(
                            prossimarevisione: _parseDateStep4(revisioneDateController.text),
                            kmUltimoCambioGomme: int.tryParse(ultimoCambioGommeController.text),
                            kmProssimoCambioGomme: int.tryParse(prossimoCambioGommeController.text),
                            kmUltimaInversioneGomme: int.tryParse(ultimaInversioneController.text),
                            kmProssimaInversioneGomme: int.tryParse(prossimaInversioneController.text),
                          ),
                        );
                      },
                    ),
